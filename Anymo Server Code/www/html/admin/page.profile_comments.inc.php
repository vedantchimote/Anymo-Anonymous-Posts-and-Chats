<?php
    ...
    if (!empty($_POST)) {
        ...
        if ($inbox_loaded != 0) {
            ...
            if ($inbox_loaded >= $inbox_all) {

                ob_start();

                ?>

                    <a href="javascript:void(0)" onclick="Flow.moreItems('<?php echo $result['itemId']; ?>'); return false;">
    ...
    $page_id = "profile_comments";

    $css_files = array("mytheme.css");
    $page_title = "Account Comments Stream | Admin Panel";
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Account Comments Stream</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Account Comments Stream</h4>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            var account_id = <?php echo $accountInfo['id']; ?>;

            window.Flow || ( window.Flow = {} );

            Flow.remove = function (offset, accessToken, action) {

                $.ajax({
                    type: 'GET',
                    url: '/admin/stream_comments?itemId=' + offset + '&access_token=' + accessToken + "&act=" + action,
            ...
            Flow.moreItems = function (offset) {

                $('div.loading-more-container').hide();

                $.ajax({
                    type: 'POST',
                    url: '/admin/stream_comments?id=' + account_id,
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <h6><a href="/admin/item?id=<?php echo $item['itemId']; ?>"><i class="ti-comment"></i> Comment to Item</a></h6>
                </td>
                <td>
                    ...
                    <?php
                        ...
                        if (strlen($item['comment']) != 0) {
                            ...
                            ?>
                            <h6 style="white-space: normal"><?php echo $item['comment']; ?></h6>
                            <?php
                ...
                <td>
                    <a href="javascript:void(0)" onclick="Flow.remove('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', 'remove'); return false;" class="text-inverse"><i class="ti-trash"></i> Delete</a>
                </td>
            </tr>
