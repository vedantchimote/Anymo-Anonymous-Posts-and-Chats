<?php
    ...
    $page_id = "profile_messages";

    $css_files = array("mytheme.css");
    $page_title = "Account Messages Stream | Admin Panel";
    ...
    <div id="main-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Account Messages Stream</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Account Messages Stream</h4>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            Messages.moreItems = function (offset) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/admin/profile_messages?id=' + account_id,
